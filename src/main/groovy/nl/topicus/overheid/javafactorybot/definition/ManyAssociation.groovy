 ...
 */
class ManyAssociation<T> extends BaseAssociation<T> {
     ...
     * @param factoryClass The type of factory to use for the associated object.
     ...
     * @param traits List of traits to apply to the associated object.
     */
    ManyAssociation(Class<BaseFactory<T, ? extends Faker>> factoryClass, int amount, Map<String, Object> defaultItemOverrides = null, List<String> traits = null) {
        super(factoryClass)
        this.amount = amount
        this.defaultItemOverrides = defaultItemOverrides
        this.traits = traits
     ...
     * @param traits List of traits to apply to the associated object.
     */
    ManyAssociation(Class<BaseFactory<T, ? extends Faker>> factoryClass, List<Object> defaultOverrides, List<String> traits = null) {
        super(factoryClass)
        this.amount = defaultOverrides.size()
        this.defaultOverrides = defaultOverrides
        this.traits = traits
